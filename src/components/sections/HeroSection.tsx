...
export default function HeroSection() {
  return (
    <section id="profile" className="py-16 md:py-24 text-center animate-fade-in">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-8 h-32 w-32 md:h-40 md:w-40 rounded-full overflow-hidden shadow-lg border-4 border-primary">
          <Image
